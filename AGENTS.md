...
- Continual-learning plugin active; agents-memory-updater subagent maintains this file; transcripts stored under `d-graphene` Cursor project slug (graphene project folder)
